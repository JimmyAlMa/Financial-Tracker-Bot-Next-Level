...
def build_system_prompt() -> str:
    ...
    return (
        ...
        "- rekap_bulanan: user minta ringkasan/laporan keuangan bulanan\n"
        "- rekap_tanggal: user minta ringkasan/laporan keuangan hari tertentu\n"
        "- pesan_tidak_dikenali: pesan tidak berkaitan dengan keempat hal di atas\n\n"
